...
const createBook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield book_service_1.BookService.createBook(Object.assign(Object.assign({}, bookData), { userEmail }));
...
const getAllBook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, filterableFields_1.bookFilterableFields);
...
//* get by year
const getAllBookByYear = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const paginationOption = (0, pick_1.default)(req.query, paginationC_1.paginationFields);
    ...
    const result = yield book_model_1.Book.find().sort(sortConditions).select({
        publicationDate: 1,
    });
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
...
const addReview = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield book_model_1.Book.updateOne({ _id: id }, { $push: { reviews: addReview } });
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getAllReview = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    console.log(id);
    const result = yield book_model_1.Book.findOne({ _id: id }).select({ reviews: 1, _id: 0 });
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
