...
//* create a Book
const createBook = cow =>
  __awaiter(void 0, void 0, void 0, function* () {
    let newCowAllData = null;
    const session = yield mongoose_1.default.startSession();
    try {
      session.startTransaction();
      const newBook = yield book_model_1.Book.create([cow], { session });
      if (!newBook.length) {
...
//* Get all Book
const getAllBook = (filters, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
//* Update a book
const updateBook = (id, payload, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteBook = (id, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield book_model_1.Book.findByIdAndDelete(
      { _id: id },
      { new: true },
    );
