...
const createWishList = (wishList, userEmail) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (existingWishList) {
        yield wishList_model_1.WishList.findOneAndUpdate({ _id: existingWishList._id }, {
            status: wishList.status,
        });
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Wishlist for this book already exists');
    }
...
//* Get all wishList
const getAllWishList = (filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield wishList_model_1.WishList.find(whereCondition).populate('book');
    return {
        data: result,
    };
});
