...
const getAllWishList = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, filterableFields_1.wishListFilterableFields);
    // console.log('filters ==== ', filters);
    const result = yield WishList_service_1.WishListService.getAllWishList(filters);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
